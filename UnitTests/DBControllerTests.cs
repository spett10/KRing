...
namespace UnitTests
{
    ...
    public class DBControllerTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _cookie = new SecurityData(CryptoHashing.GenerateSalt(), CryptoHashing.GenerateSalt(), CryptoHashing.GenerateSalt(), CryptoHashing.GenerateSalt(), CryptoHashing.GenerateSalt(), CryptoHashing.GenerateSalt());
        }
